...
#0. Extract and Print Pokémon Name and ID
...
#11. Filter and Print Hidden Abilities
#response = requests.get("https://pokeapi.co/api/v2/pokemon/ditto")
json_data = response.json()
for ability in json_data["abilities"]:
...
#12. List All Game Indices
#response = requests.get("https://pokeapi.co/api/v2/pokemon/ditto")
json_data = response.json()
for gI in json_data["game_indices"]:
    print(gI["version"]["name"])

#13. Filter Game Indices by Version
#response = requests.get("https://pokeapi.co/api/v2/pokemon/ditto")
json_data = response.json()
for gI in json_data["game_indices"]:
...
#14. Extract and Print Base Stats
#response = requests.get("https://pokeapi.co/api/v2/pokemon/exeggutor")
json_data = response.json()
for stat in json_data["stats"]:
    print(stat["base_stat"])

#15. Extract and print stats that are above a certain threshold (e.g., base stat > 50).
#response = requests.get("https://pokeapi.co/api/v2/pokemon/exeggutor")
json_data = response.json()
for stat in json_data["stats"]:
...
#16. Count the Number of Moves
#response = requests.get("https://pokeapi.co/api/v2/pokemon/exeggutor")
json_data = response.json()
print("number of moves: ", len(json_data["moves"]))

#17. Extract and Print Move Names
#response = requests.get("https://pokeapi.co/api/v2/pokemon/exeggutor")
json_data = response.json()
